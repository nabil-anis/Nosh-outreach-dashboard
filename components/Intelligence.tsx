...
const Intelligence: React.FC = () => {
  const [messages, setMessages] = useState<Message[]>([
    { 
      role: 'assistant', 
      content: "Hi! I'm the NOSH AI Technical Sentinel. I oversee the 3-touch cold outreach engine. I can explain how we handle lead ingestion, the 5-day sequence logic, or the IMAP reply-detection kill switch. What part of the architecture would you like to dive into?", 
      timestamp: new Date() 
    }
  ]);
    ...
    <div className="h-[600px] flex flex-col glass rounded-[2.5rem] overflow-hidden border border-white/10 shadow-2xl relative">
      ...
      <div className="p-4 border-b border-white/5 bg-white/5 flex items-center justify-between backdrop-blur-md z-10">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h2 className="font-bold text-sm">NOSH AI Sentinel</h2>
            <p className="text-[10px] text-gray-400">Logic Core • Flow Status: Optimized</p>
          </div>
        </div>
      </div>
